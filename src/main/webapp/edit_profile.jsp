...
<div class="profile-page">
    <div class="form">
        <form class="edit-form" action="edit_profile.jsp" method="POST">
            ...
            <input type="text" placeholder="New Username" name="username" value="<%= username %>" autocomplete="off"/>
            ...
            <input type="password" placeholder="Confirm New Password" name="confirm_password" autocomplete="off"/>
