...
<td class="<%= rs.getInt("stock") == 0 ? "table-danger" : (rs.getInt("stock") <= rs.getInt("reorder_limit") ? "table-warning" : "") %>">
...
<%@ page import="java.math.BigDecimal" %>
                ...
                <td>
    <a href="<%= rs.getInt("pro_status") == 0 ? "javascript:void(0);" : "admin_edit_product.jsp?pro_id=" + rs.getInt("pro_id") %>"
