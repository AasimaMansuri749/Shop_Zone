...
<body>
    ...
    <div class="container">
        ...
        <!-- Insert Button -->
        <div>
            <a href="insert_delivery_person.jsp" class="bg-info p-3 py-2 border-0 mx-3 text-dark mb-4 insert" 
            ...
            <table class="table table-bordered border-warning">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><%= salary %></td>
                        <td>
                            <a href="admin_see_order_details_delivery_person.jsp?dp_id=<%= dpId %>" 
