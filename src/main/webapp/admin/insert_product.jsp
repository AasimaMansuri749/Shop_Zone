		<%@ page import="java.sql.*, java.util.*, java.io.*, jakarta.servlet.http.*, jakarta.servlet.annotation.MultipartConfig" %>
		    ...
		    <div class="container mt-3">
		        ...
		        <form action="insert_product.jsp" method="post" autocomplete="off">
		            ...
		            <div class="form-outline mb-4 w-50 m-auto">
		                ...
		                <input type="text" name="keywords" id="keywords" class="form-control" placeholder="Enter Keywords" required>
		            </div>
		            ...
		            <!-- Show Price -->
		            <div class="form-outline mb-4 w-50 m-auto">
		                <label for="show_price" class="form-label">Show Price:</label>
		                <input type="number" name="show_price" id="show_price" class="form-control" placeholder="Enter Show Price" required>
		            </div>
		
		            <!-- Actual Price -->
		            <div class="form-outline mb-4 w-50 m-auto">
		                <label for="actual_price" class="form-label">Actual Price:</label>
		                <input type="number" name="actual_price" id="actual_price" class="form-control" placeholder="Enter Actual Price" required>
		            </div>
		            ...
		            <div class="form-outline mb-4 w-50 m-auto">
		                ...
		                <input type="number" name="discount" id="discount" class="form-control" placeholder="Enter Discount Percentage (Optional)">
		            </div>
		            
		            <!-- Image Path -->
		            <div class="form-outline mb-4 w-50 m-auto">
		                <label for="image_path" class="form-label">Image Path:</label>
		                <input type="text" name="image_path" id="image_path" class="form-control" placeholder="Enter Image Path as (img/product_img/p1.jpg)" required>
		            </div>
		
		            <!-- Submit Button -->
		            <div class="form-outline mb-4 w-50 m-auto text-center">
		                <button type="submit" name="insert_product" class="btn btn-success btn-lg">Insert Product</button>
		            </div>
		        </form>
		    </div>
		</body>
