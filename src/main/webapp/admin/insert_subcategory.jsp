    ...
    <div class="container mt-3">
        ...
        <form action="" method="POST" autocomplete="on">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="sub_category_name" id="sub_category_name" class="form-control" placeholder="Enter subcategory name" required="required">
            </div>

            <!-- Parent Category Dropdown -->
            <div class="form-outline mb-4 w-50 m-auto">
                <label for="parent_category" class="form-label">Select Parent Category</label>
                <select name="parent_category" id="parent_category" class="form-control" required="required">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="file" name="sub_cat_i" id="sub_cat_i" class="form-control" required="required">
            </div>

            <!-- Submit -->
            <div class="form-outline mb-4 w-50 m-auto">
                <input type="submit" value="Insert Subcategory" name="insert_subcategory" class="btn btn-info mb-3 px-3">
            </div>
