...
<%@ page import="java.sql.*, javax.sql.*,project.*, javax.naming.*, jakarta.servlet.*, jakarta.servlet.http.*, java.io.*" %>
   ...
   <%
    ...
    <td>
        ...
        %>
            ...
            <img src="<%= request.getContextPath() + "/" + imagePath %>" alt="Product Image" width="100" height="100">
        <% } else { %>
