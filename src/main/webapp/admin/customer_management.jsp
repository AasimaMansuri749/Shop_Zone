...
<html lang="en">
   ...
   <%
    ...
    try {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_zone", "root", ""); // Replace with actual password
            ...
            <tr>
                ...
                <td>
                    ...
                    <%
                        if (orderId > 0) {
                    %>
<a href="list_of_orders_of_customer.jsp?see_order_details=<%= orderId %>&cust_id=<%= cust_id %>&username=<%= username %>" class="btn btn-secondary col-12 mb-2">list of orders</a>
                    <%
                        } else {
                    %>
