...
<body class="bg-gray">
    ...
    <div class="bg-Sacondary">
        ...
        <div class="container-fluid dashboard-section">
            <div class="row">
                <div class="col-lg-3">
                    <a href="customer_management.jsp" class="btn btn-success w-100 bg-success justify-content-center d-flex text-center rounded-3 mb-2 fs-3">
                        Customer
                    </a>

                    <a href="order_management.jsp" class="btn btn-success w-100 bg-success justify-content-center d-flex text-center rounded-3 mb-2 fs-3">
                        Order
                    </a>

                    <a href="product_management.jsp" class="btn btn-success w-100 bg-success justify-content-center d-flex text-center rounded-3 mb-2 fs-3">
                        Product
                    </a>

                    <a href="admin_manage_category.jsp" class="btn btn-success w-100 bg-success justify-content-center d-flex text-center rounded-3 mb-2 fs-3">
                        Category
                    </a>

                    <a href="delivery_person_management.jsp" class="btn btn-success w-100 bg-success justify-content-center d-flex text-center rounded-3 mb-2 fs-3">
                        Delivery Person
                    </a>

                    <a href="report_managment.jsp" class="btn btn-success w-100 bg-success justify-content-center d-flex text-center rounded-3 mb-2 fs-3">
                        Report
                    </a>
                </div>
...
<div class="col-lg-4 text-center bg-secondary text-white p-3 mb-3 rounded w-25 m-3">
