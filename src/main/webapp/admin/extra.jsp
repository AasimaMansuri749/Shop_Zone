...
<%@ page import="java.sql.*, jakarta.servlet.http.HttpSession ,project.connection" %>
...
<div  class="bg-Sacondary">
    ...
    <div class="row">
    <div class="col-lg-3">
    	<div class="w-75 bg-success justify-content-center d-flex text-center rounded-3 mb-2"> 
<!--     		<div class="fs-1 "> -->
    			<a href="customer_management.jsp" class="btn btn-success  fs-3">Customer</a>
<!--     		</div> -->
    	</div>
    	
    	<div class="w-75 bg-success justify-content-center d-flex text-center rounded-3 mb-3"> 
<!--     		<div class="fs-1 "> -->
...
<!--     		</div> -->
    	...
    	<div class="w-75 bg-success justify-content-center d-flex text-center rounded-3 mb-3"> 
<!--     		<div class="fs-1 "> -->
    			<a href="delivery_person_management.jsp" class="btn btn-success  fs-3">Delivery Person</a>
<!--     		</div> -->
    	</div>
    	<div class="w-75 bg-success justify-content-center d-flex text-center rounded-3 mb-3"> 
<!--     		<div class="fs-1 "> -->
