...
<!-- 											class="dropdown-item" type="button">Edit Profile</button></a>  -->
											<a
										href="order_history.jsp"><button class="dropdown-item"
...
<%
    ...
    try {
        ...
        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/shop_zone", "root", "jinal@NEW123");
...
<!--                     <form action="checkout.jsp" method="post"> -->
    <input type="hidden" name="cart_ids" value="<%= cartIdsParam %>">
      ...
      <input type="hidden" name="total_num_items" value="<%=total_num_items %>">
...
<!--                         </div> -->
                        <div class="col-md-12 form-group">
                            <label>E-mail</label>
                            <input class="form-control" type="email" name="email" value="<%=user_email %>" placeholder="example@email.com" readonly required>
                        </div>
<!--                         <div class="col-md-12 form-group"> -->
...
<!--                         </div> -->
                        ...
                        <div class="col-md-12 form-group">
                            <label>State</label>
                            <input class="form-control" type="text" name="state" value="Gujarat" readonly>
                        </div>
                        <div class="col-md-12 form-group">
                            <label>City</label>
                            <input class="form-control" type="text" name="city" value="Ahmedabad" readonly>
                        </div>
<div class="col-md-12 form-group">
    <label>Search Area</label>
    <select class="form-control" id="searchArea" name="searchArea" required>
        ...
        <% } %>
            ...
            <div class="h4 " class=""> <span>Total Amount: </span><span >Rs. <%=grandTotal %></span></div>
            <div class="mb-5">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Payment By</span></h5>
                <div class="bg-light pt	-30">
                    ...
                    <button class="btn btn-block btn-primary font-weight-bold py-3" type="submit" form="checkoutForm">Place Order</button>
                </div>
            </div>
                </form>
            </div>
