		...
		<div class="form">
			<form class="register-form" action="signup.jsp" method="POST">
				...
				<input type="text" placeholder="name" name="name"
					value="<%=name != null ? name : ""%>" autocomplete="off"/> <span class="error">*<%=nameError%></span>

				<input type="email" placeholder="email address" name="email"
					value="<%=email != null ? email : ""%>" autocomplete="off"/> <span class="error">*<%=emailError%></span>

				<input type="password" placeholder="password" name="password" autocomplete="off"/> <span
