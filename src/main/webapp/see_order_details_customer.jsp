			...
			<div id="hotbox">
				<div class="box">
					...
					<div class="row text-center m-auto mt-3">
						<h3 class="d-flex justify-content-center text-center fs-2">Items in Order</h3>
...
<!-- 									<td  class="fs-3"></td> -->
								...
								class="text-dark"> <img src="<%=rsItems.getString("path")%>" alt="<%=rsItems.getString("title")%>"
									style="width: 130px; height: 150px"></a> </td> <td class="align-middle fs-3"> <%=rsItems.getString("title")%>
							</td>
...
<section class="" style="background-color: #eee;">
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center  text-center">
      <div class="col">
        <button type="button" class="btn btn-warning btn-lg" data-mdb-toggle="modal" data-mdb-target="#exampleModal1">
  Track your order
</button>
...
<!--       </div> -->
      <div class="modal-body">
        <h5 class="text-center" id="statusText">Order Status</h5> <!-- Dynamic status text -->
