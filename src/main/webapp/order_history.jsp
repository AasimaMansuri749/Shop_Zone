...
<%@ page import="java.sql.*, jakarta.servlet.*, jakarta.servlet.http.*,project.connection" %>
<%
...
<!--                 </form> -->
                <a href="see_order_details_customer.jsp?order_id=<%= rs.getInt("order_id") %>">
...
%>
        <tr>
            <td colspan="6" class="text-center text-danger">Error fetching data: <%= e.getMessage() %></td>
        </tr>
<%
    }
%>
