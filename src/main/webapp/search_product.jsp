                    ...
                    <div class="dress-card h-100" style="width: 100%;">
                        <div class="dress-card-head">
                            <a href="product_detail.jsp?pro_id=<%=p_id%>"> 
                                <img class="dress-card-img-top img-fluid product-image" src="<%=imagePath%>" alt="<%=imagePath%>">
                            </a>
                            <div class="dress-card-body">
                                <p class="dress-card-para mb-3 text-truncate"><%=title%></p>

                                <p class="dress-card-para">
                                    <span class="dress-card-price">Rs. <%=discountPrice%>&ensp;</span>
                                    <span class="dress-card-crossed">Rs. <%=showPrice%></span>
