							...
							<div class="btn-group mr-2 ">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<a href="logout.jsp"><button class="dropdown-item"
											...
											class="dropdown-item" type="button">Order History</button></a>
...
<input type="checkbox" name="selectedProducts" value="<%= total %>" data-cart-id="<%= rs.getInt("cart_id") %>" class="productCheckbox" 
       onclick="updateSelectedTotal()"
       <% if (isOutOfStock) { %> disabled <% } %> > <!-- Disable the checkbox if out of stock -->
    <br>	
    <%-- Display error message if product is out of stock or selected quantity exceeds stock --%>
<%
...
%>
    ...
    <div class="input-group quantity mx-auto" style="width: 100px;">
        ...
        <a href="update_quantity.jsp?pro_id=<%=proId%>&update=1" 
           <%
            ...
            <div class="input-group-btn">
                <div class="btn btn-sm btn-primary btn-plus">
					...
					<div class="col-lg-4 mt-4">
						<h5 class="section-title position-relative text-uppercase mb-3 mt-54">
						...
						<div class="bg-light p-30 mb-5">
							<div class="border-bottom pb-2">
								<div class="d-flex justify-content-between mb-3">
									...
									<h6>Rs. <span id="selectedTotal">0</span>
...
<div class="pt-2">
    <div
        ...
        onclick="proceedToCheckout()"> <!-- Call the proceedToCheckout function -->
        Proceed to Checkout
    </div>
</div>
<!-- Error message div -->
<div id="errorMessage" style="color: red; display: none;">
    Please select at least one product before proceeding to checkout.
					...
					<div class="col-lg-8 mt-4 align-item-end fs-4">
						<h5 class="section-title position-relative text-uppercase mb-3 mt-54"><p class="fs-1">
							<span  class="bg-primary pr-3 btn btn-block btn-primary font-weight-bold my-3 py-3 fs-1 xc">
							Total cart value: <%=grandTotal%> </span></p>
						</h5>
