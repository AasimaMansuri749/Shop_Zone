...
<!-- 						<h6 class="text-white text-uppercase">20% Discount</h6> -->
						...
						<a href="shop.jsp?filter_option_gender=3"
...
<!-- 						<h6 class="text-white text-uppercase">60% Discount</h6> -->
						...
						<a href="shop.jsp?filter_option_gender=2"
							class="btn btn-primary">Shop Now</a>
					</div>
				</div>
			</div>
...
//         categoryMap.put("Boy Kid", 4); // p_cat_id for Boy Kid
    ...
    %>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="shop.jsp?filter_option_gender=<%= pCatId %>&category=<%= sub_cat_id %>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="<%= subCatPicPath %>" alt="<%= subCatName %>">
                        </div>
	...
	<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
		<div class="row px-xl-5 pt-5">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				...
				outfits to classic wardrobe essentials. 
				Explore our collection and find the perfect pieces for you and your family!</p>
