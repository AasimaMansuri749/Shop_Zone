...
<!--     <form id="filterForm" method="GET" action="yourFilterAction.jsp"> -->
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="price-1" name="priceRange" value="0-1000"
                onchange="document.getElementById('filterForm').submit();"
        ...
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="price-2" name="priceRange" value="1000-2000"
                onchange="document.getElementById('filterForm').submit();"
        ...
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="price-3" name="priceRange" value="2000-3000"
                onchange="document.getElementById('filterForm').submit();"
        ...
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="price-4" name="priceRange" value="3000-4000"
                onchange="document.getElementById('filterForm').submit();"
        ...
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between">
            <input type="checkbox" class="custom-control-input" id="price-5" name="priceRange" value="4000-5000"
                onchange="document.getElementById('filterForm').submit();"
...
<!--     <form id="filterForm" method="GET" action="yourFilterAction.jsp"> -->
        <!-- Discount Filters -->
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="discount-1" name="discount" value="0-5"
                onchange="document.getElementById('filterForm').submit();"
                <%= selectedDiscounts != null && selectedDiscounts.contains("0-5") ? "checked" : "" %>>
            <label class="custom-control-label" for="discount-1">0% - 5%</label>
        </div>
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="discount-2" name="discount" value="5-10"
                onchange="document.getElementById('filterForm').submit();"
                <%= selectedDiscounts != null && selectedDiscounts.contains("5-10") ? "checked" : "" %>>
            <label class="custom-control-label" for="discount-2">5% - 10%</label>
        </div>
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="discount-3" name="discount" value="10-15"
                onchange="document.getElementById('filterForm').submit();"
                <%= selectedDiscounts != null && selectedDiscounts.contains("10-15") ? "checked" : "" %>>
            <label class="custom-control-label" for="discount-3">10% - 15%</label>
        </div>
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="discount-4" name="discount" value="15-20"
                onchange="document.getElementById('filterForm').submit();"
                <%= selectedDiscounts != null && selectedDiscounts.contains("15-20") ? "checked" : "" %>>
            <label class="custom-control-label" for="discount-4">15% - 20%</label>
        </div>
        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="discount-5" name="discount" value="20-25"
                onchange="document.getElementById('filterForm').submit();"
                <%= selectedDiscounts != null && selectedDiscounts.contains("20-25") ? "checked" : "" %>>
            <label class="custom-control-label" for="discount-5">20% - 25%</label>
        </div>
<!--     </form> -->
</div>
...
<div class="col-lg-9 col-md-8">
    ...
    <div class="row pb-3">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="dress-card h-100" style="width: 100%;">
                <a href='product_detail.jsp?pro_id=<%=p_id%>'>
                    <img class="dress-card-img-top img-fluid product-image" src="<%=imagePath%>" alt="<%=title%>">
                </a>
                <div class="dress-card-body">
                    <p class="dress-card-para mb-3 text-truncate"><%=title%></p>
                    <p class="dress-card-para">
                        <span class="dress-card-price">₹ <%=discountPrice%>&ensp;</span>
                        <span class="dress-card-crossed">₹ <%=showPrice%></span>
                        <span class="dress-card-off">&ensp;(<%=(int) discount%> % OFF)</span>
                    </p>
                    <div class="row">
                        <div class="col-md-6 card-button">
