...
<body>
    ...
    <a href="insert_product.jsp" class="bg-info p-3 text-dark insert" style="display: inline-block; text-decoration: none;">Insert New Product</a>
...
<td class="<%= rs.getInt("stock") <= rs.getInt("reorder_limit") ? "table-warning" : "" %>">
    <%= rs.getInt("stock") %>
</td>
                ...
                <td>
                    <a href="admin_edit_product.jsp?pro_id=<%= rs.getInt("pro_id") %>" class="btn btn-secondary">Edit</a>
                </td>
                <td>
                    <a href="javascript:void(0);" class="btn btn-danger" onclick="confirmDelete(<%= rs.getInt("pro_id") %>)">Delete</a>
                </td>
            </tr>
            <%
                    }
